	...
	<div class="misc-wrapper">
		...
		<div class="misc-inner p-2 p-sm-3">
			<div class="w-100 text-center">
				...
				<p class="mb-2">
					Oops! 😖 Aradığınız sayfa bulunamadı.</p>
					<a href="{{ site_url('admin/dashboard') }}" class="btn btn-primary mb-2 btn-sm-block">
						Anasayfaya Git
					</a>
				<img src="{{ asset_url('app/images/pages/error.svg') }}" alt="Error page" class="img-fluid">
			</div>
		</div>
	</div>
	<!-- / Error page -->
