							...
							<table class="datatables-basic table">
								...
								<tbody>
									...
									@foreach ($holidays as $holiday)
										...
										<tr>
											<td>
												<img src="{{ asset_url('app/images/avatars/default.jpg') }}" alt="{{ $holiday->username }}" width="20" height="20" class="me-75 avatar">
												<span class="fw-bold">{{ $holiday->username }}</span>
											</td>
											<td>
											...
											<td>
												<div class="dropdown">
													...
													<div class="dropdown-menu dropdown-menu-end">
														<a href="{{ site_url('admin/employees/holiday/edit/' . $holiday->id) }}" class="dropdown-item">
															<i data-feather="edit-2" class="me-50"></i>
															<span>Düzenle</span>
														</a>
														<a href="{{ site_url('admin/employees/holiday/delete/' . $holiday->id) }}" class="dropdown-item">
				...
				<div class="col-12">
					<div class="alert alert-info" role="alert">
						<div class="alert-body">
							Sistemde kayıtlı personel izni bulunamadı.
						</div>
					</div>
				</div>
			</div>
