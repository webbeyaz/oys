...
@section('content')
	...
	<div class="auth-wrapper auth-basic px-2">
		<div class="auth-inner my-2">
			...
			<div class="card mb-0">
				<div class="card-body">
					<a href="{{ site_url('admin/recovery') }}" class="brand-logo">
					...
					<form action="" method="post" class="auth-reset-password-form mt-2">
						<div class="mb-1">
							...
							<input type="email" name="email" placeholder="E-posta adresi" class="form-control form-control-merge" id="email" aria-describedby="email" tabindex="1" autofocus>
						</div>
