											...
											@if ($images)
												...
												<div class="avatar-group">
													...
													@foreach ($images[$event->id] as $image)
														...
														<div title="1" class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom">
															<img src="{{ upload_url('images/cache/events/33x33/' . $image) }}" alt="1" width="33" height="33">
														</div>
