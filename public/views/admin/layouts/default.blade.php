...
<head>
	...
	<!-- BEGIN: Icon -->
	<link rel="apple-touch-icon" href="{{ asset_url('admin/app/images/ico/apple-icon-120.png') }}">
	<link rel="shortcut icon" type="image/x-icon" href="../../../app/images/ico/favicon.ico">
